...
We demonstrate that this two-component modification produces UV LFs in excellent agreement with JWST data at $z = 10$--16 while preserving consistency with well-established observations at $z = 4$--8.
...
The redshift-dependent SFE is the dominant mechanism, reducing $\chi^2_{\rm red}(z \geq 10)$ from 79.1 to 3.7 (a 95.3\% improvement). Feedback weakening alone has minimal impact (79.1 $\to$ 60.5) but provides essential complementary improvement when combined with the SFE boost (3.7 $\to$ 0.41).
